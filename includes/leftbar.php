...
<li><a href="manage-bloodgroup.php">Manage Blood Group</a></li>
				...
				<li><a href="#"><i class="fa fa-files-o"></i>List</a>
				<ul>
				<li><a href="donor-list.php"><i class="fa fa-users"></i> Donor List</a></li>
				<li><a href="requestlist.php"><i class="fa fa-files-o"></i> Blood Request List</a></li>
				</ul>
				</li>
				
			<li><a href="exchange.php"><i class="fa fa-edit"></i>Exchange Blood</a></li>
			<li><a href="stock.php"><i class="fa fa-edit"></i>Stock Blood List</a></li>
            <li><a href="outstock.php"><i class="fa fa-edit"></i>Out Stock Blood List</a></li>
			<li><a href="exchangelist.php"><i class="fa fa-edit"></i>Exchange Blood List</a></li>
			<li><a href="#"><i class="fa fa-files-o"></i>Manage</a>
				<ul>
